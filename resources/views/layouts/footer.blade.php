                ...
                <div class="row gy-3 justify-content-between align-items-center">
                    <div class="col-lg-3">
                        <div class="rv-9-footer-logo text-sm-center text-lg-start">
                            <a href="index.html">
                                <img src="{{ asset('assets/img/rv-20-logo-light.png') }}" alt="logo" class="logo">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6">
                        <div class="rv-1-footer-widget rv-8-footer-articles">
                            ...
                            <div class="rv-8-footer-article rv-20-footer-article">
                                <img src="{{ asset('assets/img/rv-9-footer-article-1.jpg') }}" alt="Article image" class="rv-8-footer-article-img">
                            ...
                            <div class="rv-8-footer-article rv-20-footer-article">
                                <img src="{{ asset('assets/img/rv-9-footer-article-2.jpg') }}" alt="Article image" class="rv-8-footer-article-img">
