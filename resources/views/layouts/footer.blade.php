                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="rv-5-about__call rv-9-footer__contact-card rv-20-footer__contact-card">
                                    ...
                                    <div class="rv-5-about__call-txt">
                                        <h6>Telp.</h6>
                                        <a href="tel:123654564388" class="">0811-2312-3123</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="rv-5-about__call rv-9-footer__contact-card rv-20-footer__contact-card">
                                    ...
                                    <div class="rv-5-about__call-txt">
                                        <h6>Email</h6>
                                        <a href="tel:123654564388" class="">sekretariat@mail.com</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="rv-5-about__call rv-9-footer__contact-card rv-20-footer__contact-card">
                                    ...
                                    <div class="rv-5-about__call-txt">
                                        <h6> Alamat</h6>
                                        <a href="tel:123654564388" class="">Sekretariat Jl. Indonesia</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="rv-2-footer rv-8-footer-bottom">
            <div class="container">
                <div class="row align-items-center gy-3">
                    <div class="col-md-7">
                        <p class="rv-2-copyright rv-1-copyright mb-0 text-center text-md-start">&copy; 2024</p>
                    </div>
